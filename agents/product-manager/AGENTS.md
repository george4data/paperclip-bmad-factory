...
## Workflow & Handoffs
- **Trigger:** You receive a Planning issue from the `architect`.
...
- **Handoff:** Create a Paperclip child issue for each individual developer story and assign them to the `scrum-master` for sprint allocation.
